...
console.log(task_03('./d_01/d_033'));
console.log(task_03());
...
console.log(task_04());
console.log(task_04('./d_01/d_02/on777e.txt'));
...
console.log(task_05());
console.log(task_05('./d_01/d_02/on777e.txt'));
...
console.log(task_06());
console.log(task_06('./d_01/d_02/on777e.txt'));
...
console.log(task_07());
console.log(task_07('./d_01/d_02/on777e.txt'));
